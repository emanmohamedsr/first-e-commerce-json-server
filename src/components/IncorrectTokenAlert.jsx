...
const IncorrectTokenAlert = ({ setIncorrectAlert, incorrectAlert }) => {
	return (
		<div className='alert absolute top-0 sm:w-[400px] md:w-[600px] lg:w-[800px] left-[50%] backdrop-blur-xl -translate-x-[50%]'>
			<div className='relative w-full flex flex-wrap items-center justify-center py-3 pl-4 pr-14 rounded-lg text-base font-medium [transition:all_0.5s_ease] border-solid border border-[#f85149] text-[#b22b2b] [&_svg]:text-[#b22b2b] group bg-[linear-gradient(#f851491a,#f851491a)]'>
				<button
					onClick={() => setIncorrectAlert({ show: false, mess: "" })}
					type='button'
...
export default IncorrectTokenAlert;
